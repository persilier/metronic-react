  ...
  <div className="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
    ...
    <div className="d-flex align-items-stretch" id="kt_header_nav">
      ...
      <div className="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
        {/*begin::Menu*/}
        <div className="my-5 menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
          <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" className="menu-item here show menu-lg-down-accordion me-lg-1">
            ...
            <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
              <div className="menu-item">
                <a className="py-3 menu-link active" href="../../demo1/dist/index.html">
              ...
              <div className="menu-item">
                <a className="py-3 menu-link" href="../../demo1/dist/dashboards/ecommerce.html">
                  <span className="menu-bullet">
                    <span className="bullet bullet-dot" />
                  </span>
              ...
              <div className="menu-item">
                <a className="py-3 menu-link" href="../../demo1/dist/dashboards/projects.html">
                  <span className="menu-bullet">
                    <span className="bullet bullet-dot" />
                  </span>
              ...
              <div className="menu-item">
                <a className="py-3 menu-link" href="../../demo1/dist/dashboards/online-courses.html">
                  <span className="menu-bullet">
                    <span className="bullet bullet-dot" />
                  </span>
              ...
              <div className="menu-item">
                <a className="py-3 menu-link" href="../../demo1/dist/dashboards/marketing.html">
                  <span className="menu-bullet">
                    <span className="bullet bullet-dot" />
                  </span>
              ...
              <div className="menu-item">
                <a className="py-3 menu-link" href="../../demo1/dist/dashboards/bidding.html">
                  <span className="menu-bullet">
                    <span className="bullet bullet-dot" />
                  </span>
              ...
              <div className="menu-inner flex-column collapse" id="kt_aside_menu_collapse_2">
                <div className="menu-item">
                  <a className="py-3 menu-link" href="../../demo1/dist/dashboards/logistics.html">
                    <span className="menu-bullet">
                      <span className="bullet bullet-dot" />
                    </span>
                ...
                <div className="menu-item">
                  <a className="py-3 menu-link" href="../../demo1/dist/dashboards/delivery.html">
                    <span className="menu-bullet">
                      <span className="bullet bullet-dot" />
                    </span>
                ...
                <div className="menu-item">
                  <a className="py-3 menu-link" href="../../demo1/dist/dashboards/website-analytics.html">
                    <span className="menu-bullet">
                      <span className="bullet bullet-dot" />
                    </span>
                ...
                <div className="menu-item">
                  <a className="py-3 menu-link" href="../../demo1/dist/dashboards/finance-performance.html">
                    <span className="menu-bullet">
                      <span className="bullet bullet-dot" />
                    </span>
                ...
                <div className="menu-item">
                  <a className="py-3 menu-link" href="../../demo1/dist/dashboards/store-analytics.html">
                    <span className="menu-bullet">
                      <span className="bullet bullet-dot" />
                    </span>
                ...
                <div className="menu-item">
                  <a className="py-3 menu-link" href="../../demo1/dist/dashboards/social.html">
                    <span className="menu-bullet">
                      <span className="bullet bullet-dot" />
                    </span>
                ...
                <div className="menu-item">
                  <a className="py-3 menu-link" href="../../demo1/dist/dashboards/crypto.html">
                    <span className="menu-bullet">
                      <span className="bullet bullet-dot" />
                    </span>
                ...
                <div className="menu-item">
                  <a className="py-3 menu-link" href="../../demo1/dist/dashboards/school.html">
                    <span className="menu-bullet">
                      <span className="bullet bullet-dot" />
                    </span>
                ...
                <div className="menu-item">
                  <a className="py-3 menu-link" href="../../demo1/dist/dashboards/podcast.html">
                    <span className="menu-bullet">
                      <span className="bullet bullet-dot" />
                    </span>
                ...
                <div className="menu-item">
                  <a className="py-3 menu-link" href="../../demo1/dist/landing.html">
                    <span className="menu-bullet">
                      <span className="bullet bullet-dot" />
                    </span>
              ...
              <div className="menu-item">
                <div className="menu-content">
                  <a className="p-0 mb-2 btn btn-flex btn-color-success fs-base ms-2 collapsible collapsed rotate" data-bs-toggle="collapse" href="#kt_aside_menu_collapse_2" data-kt-toggle-text="Show Less">
                    <span data-kt-toggle-text-target="true">Show 10 More</span>
                    {/*begin::Svg Icon | path: icons/duotune/arrows/arr082.svg*/}
                    <span className="rotate-180 svg-icon ms-2 svg-icon-3">
                      <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
          ...
          <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" className="menu-item menu-lg-down-accordion me-lg-1">
            ...
            <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                ...
                <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                  <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                    ...
                    <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/pages/user-profile/overview.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/pages/user-profile/projects.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">Projects</span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/pages/user-profile/campaigns.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/pages/user-profile/documents.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/pages/user-profile/followers.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/pages/user-profile/activity.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                  ...
                  <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                    ...
                    <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/pages/blog/home.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/pages/blog/post.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                  ...
                  <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                    ...
                    <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/pages/pricing/pricing-1.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/pages/pricing/pricing-2.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                  ...
                  <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                    ...
                    <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/pages/careers/list.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/pages/careers/apply.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                  ...
                  <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                    ...
                    <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/pages/faq/classic.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/pages/faq/extended.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/pages/about.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/pages/contact.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/pages/team.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/pages/licenses.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/pages/sitemap.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
              ...
              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                ...
                <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/account/overview.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                      <span className="menu-title">Overview</span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/account/settings.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/account/security.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/account/billing.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/account/statements.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/account/referrals.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/account/api-keys.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/account/logs.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
              ...
              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                ...
                <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                  <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                    ...
                    <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/layouts/basic/sign-in.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/layouts/basic/sign-up.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/layouts/basic/two-steps.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/layouts/basic/password-reset.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/layouts/basic/new-password.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                  ...
                  <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                    ...
                    <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/layouts/aside/sign-in.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">Sign-in</span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/layouts/aside/sign-up.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">Sign-up</span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/layouts/aside/two-steps.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">Two-steps</span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/layouts/aside/password-reset.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">Password Reset</span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/layouts/aside/new-password.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">New Password</span>
                  ...
                  <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                    ...
                    <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/layouts/dark/sign-in.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">Sign-in</span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/layouts/dark/sign-up.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">Sign-up</span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/layouts/dark/two-steps.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">Two-steps</span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/layouts/dark/password-reset.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">Password Reset</span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/layouts/dark/new-password.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">New Password</span>
                  ...
                  <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                    ...
                    <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/extended/two-factor-authentication.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/extended/multi-steps-sign-up.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/extended/free-trial-sign-up.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/extended/coming-soon.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/general/welcome.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/general/verify-email.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/general/password-confirmation.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/general/deactivation.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/general/error-404.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/general/error-500.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                  ...
                  <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                    ...
                    <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/email/verify-email.html" target="blank">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">Verify Email</span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/email/invitation.html" target="blank">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/email/password-reset.html" target="blank">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">Password Reset</span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/authentication/email/password-change.html" target="blank">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
              ...
              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                ...
                <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                  <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                    ...
                    <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                        ...
                        <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                          <div className="menu-item">
                            <a className="py-3 menu-link" href="../../demo1/dist/utilities/modals/general/invite-friends.html">
                              <span className="menu-bullet">
                                <span className="bullet bullet-dot" />
                              </span>
                          ...
                          <div className="menu-item">
                            <a className="py-3 menu-link" href="../../demo1/dist/utilities/modals/general/view-users.html">
                              <span className="menu-bullet">
                                <span className="bullet bullet-dot" />
                              </span>
                          ...
                          <div className="menu-item">
                            <a className="py-3 menu-link" href="../../demo1/dist/utilities/modals/general/upgrade-plan.html">
                              <span className="menu-bullet">
                                <span className="bullet bullet-dot" />
                              </span>
                          ...
                          <div className="menu-item">
                            <a className="py-3 menu-link" href="../../demo1/dist/utilities/modals/general/share-earn.html">
                              <span className="menu-bullet">
                                <span className="bullet bullet-dot" />
                              </span>
                      ...
                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                        ...
                        <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                          <div className="menu-item">
                            <a className="py-3 menu-link" href="../../demo1/dist/utilities/modals/forms/new-target.html">
                              <span className="menu-bullet">
                                <span className="bullet bullet-dot" />
                              </span>
                          ...
                          <div className="menu-item">
                            <a className="py-3 menu-link" href="../../demo1/dist/utilities/modals/forms/new-card.html">
                              <span className="menu-bullet">
                                <span className="bullet bullet-dot" />
                              </span>
                          ...
                          <div className="menu-item">
                            <a className="py-3 menu-link" href="../../demo1/dist/utilities/modals/forms/new-address.html">
                              <span className="menu-bullet">
                                <span className="bullet bullet-dot" />
                              </span>
                          ...
                          <div className="menu-item">
                            <a className="py-3 menu-link" href="../../demo1/dist/utilities/modals/forms/create-api-key.html">
                              <span className="menu-bullet">
                                <span className="bullet bullet-dot" />
                              </span>
                          ...
                          <div className="menu-item">
                            <a className="py-3 menu-link" href="../../demo1/dist/utilities/modals/forms/bidding.html">
                              <span className="menu-bullet">
                                <span className="bullet bullet-dot" />
                              </span>
                              <span className="menu-title">Bidding</span>
                      ...
                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                        ...
                        <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                          <div className="menu-item">
                            <a className="py-3 menu-link" href="../../demo1/dist/utilities/modals/wizards/two-factor-authentication.html">
                              <span className="menu-bullet">
                                <span className="bullet bullet-dot" />
                              </span>
                              <span className="menu-title">Two Factor Auth</span>
                          ...
                          <div className="menu-item">
                            <a className="py-3 menu-link" href="../../demo1/dist/utilities/modals/wizards/create-app.html">
                              <span className="menu-bullet">
                                <span className="bullet bullet-dot" />
                              </span>
                          ...
                          <div className="menu-item">
                            <a className="py-3 menu-link" href="../../demo1/dist/utilities/modals/wizards/create-campaign.html">
                              <span className="menu-bullet">
                                <span className="bullet bullet-dot" />
                              </span>
                          ...
                          <div className="menu-item">
                            <a className="py-3 menu-link" href="../../demo1/dist/utilities/modals/wizards/create-account.html">
                              <span className="menu-bullet">
                                <span className="bullet bullet-dot" />
                              </span>
                          ...
                          <div className="menu-item">
                            <a className="py-3 menu-link" href="../../demo1/dist/utilities/modals/wizards/create-project.html">
                              <span className="menu-bullet">
                                <span className="bullet bullet-dot" />
                              </span>
                          ...
                          <div className="menu-item">
                            <a className="py-3 menu-link" href="../../demo1/dist/utilities/modals/wizards/offer-a-deal.html">
                              <span className="menu-bullet">
                                <span className="bullet bullet-dot" />
                              </span>
                      ...
                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                        ...
                        <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                          <div className="menu-item">
                            <a className="py-3 menu-link" href="../../demo1/dist/utilities/modals/search/users.html">
                              <span className="menu-bullet">
                                <span className="bullet bullet-dot" />
                              </span>
                          ...
                          <div className="menu-item">
                            <a className="py-3 menu-link" href="../../demo1/dist/utilities/modals/search/select-location.html">
                              <span className="menu-bullet">
                                <span className="bullet bullet-dot" />
                              </span>
                  ...
                  <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                    ...
                    <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/utilities/search/horizontal.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/utilities/search/vertical.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/utilities/search/users.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">Users</span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/utilities/search/select-location.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                  ...
                  <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                    ...
                    <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/utilities/wizards/horizontal.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">Horizontal</span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/utilities/wizards/vertical.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">Vertical</span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/utilities/wizards/two-factor-authentication.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">Two Factor Auth</span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/utilities/wizards/create-app.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">Create App</span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/utilities/wizards/create-campaign.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">Create Campaign</span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/utilities/wizards/create-account.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">Create Account</span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/utilities/wizards/create-project.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">Create Project</span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/utilities/wizards/offer-a-deal.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">Offer a Deal</span>
              ...
              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                ...
                <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/widgets/lists.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/widgets/statistics.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/widgets/charts.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/widgets/mixed.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/widgets/tables.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/widgets/feeds.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
          ...
          <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" className="menu-item menu-lg-down-accordion me-lg-1">
            ...
            <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                ...
                <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/projects/list.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/projects/project.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/projects/targets.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/projects/budget.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/projects/users.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                      <span className="menu-title">Users</span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/projects/files.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/projects/activity.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                      <span className="menu-title">Activity</span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/projects/settings.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                      <span className="menu-title">Settings</span>
              ...
              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                ...
                <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                  <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                    ...
                    <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/catalog/products.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/catalog/categories.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/catalog/add-product.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/catalog/add-category.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/catalog/edit-category.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                  ...
                  <div data-kt-menu-trigger="click" className="menu-item menu-accordion">
                    ...
                    <div className="menu-sub menu-sub-accordion">
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/sales/listing.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/sales/details.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/sales/add-order.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/sales/edit-order.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                  ...
                  <div data-kt-menu-trigger="click" className="menu-item menu-accordion">
                    ...
                    <div className="menu-sub menu-sub-accordion">
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/customers/listing.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/customers/details.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                  ...
                  <div data-kt-menu-trigger="click" className="menu-item menu-accordion">
                    ...
                    <div className="menu-sub menu-sub-accordion">
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/reports/view.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/reports/sales.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                          <span className="menu-title">Sales</span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/reports/returns.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/reports/customer-orders.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/reports/shipping.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/settings.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                      <span className="menu-title">Settings</span>
              ...
              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                ...
                <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/support-center/overview.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                      <span className="menu-title">Overview</span>
                  ...
                  <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                    ...
                    <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/support-center/tickets/list.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/support-center/tickets/view.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                  ...
                  <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                    ...
                    <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/support-center/tutorials/list.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/support-center/tutorials/post.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/support-center/faq.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                      <span className="menu-title">FAQ</span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/support-center/licenses.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                      <span className="menu-title">Licenses</span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/support-center/contact.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                      <span className="menu-title">Contact Us</span>
              ...
              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                ...
                <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                  <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                    ...
                    <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/user-management/users/list.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/user-management/users/view.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                  ...
                  <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                    ...
                    <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/user-management/roles/list.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/user-management/roles/view.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/user-management/permissions.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
              ...
              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                ...
                <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/contacts/getting-started.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/contacts/add-contact.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/contacts/edit-contact.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/contacts/view-contact.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
              ...
              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                ...
                <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/subscriptions/getting-started.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                      <span className="menu-title">Getting Started</span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/subscriptions/list.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/subscriptions/add.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/subscriptions/view.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
              ...
              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                ...
                <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/customers/getting-started.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                      <span className="menu-title">Getting Started</span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/customers/list.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/customers/view.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
              ...
              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                ...
                <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                  <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                    ...
                    <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/invoices/view/invoice-1.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/invoices/view/invoice-2.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item">
                        <a className="py-3 menu-link" href="../../demo1/dist/apps/invoices/view/invoice-3.html">
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/invoices/create.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
              ...
              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                ...
                <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/file-manager/folders.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/file-manager/files.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                      <span className="menu-title">Files</span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/file-manager/blank.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/file-manager/settings.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                      <span className="menu-title">Settings</span>
              ...
              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                ...
                <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/inbox/listing.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/inbox/compose.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/inbox/reply.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
              ...
              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                ...
                <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/chat/private.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/chat/group.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/apps/chat/drawer.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
              ...
              <div className="menu-item">
                <a className="py-3 menu-link" href="../../demo1/dist/apps/calendar.html">
                  <span className="menu-icon">
          ...
          <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" className="menu-item menu-lg-down-accordion me-lg-1">
            ...
            <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                ...
                <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/layouts/toolbars/toolbar-1.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/layouts/toolbars/toolbar-2.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/layouts/toolbars/toolbar-3.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/layouts/toolbars/toolbar-4.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/layouts/toolbars/toolbar-5.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/layouts/toolbars/no-toolbar.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
              ...
              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-dropdown">
                ...
                <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/layouts/aside/light.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/layouts/aside/font-icons.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/layouts/aside/minimized.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item">
                    <a className="py-3 menu-link" href="../../demo1/dist/layouts/aside/only-header.html">
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
              ...
              <div className="menu-item">
                <a className="py-3 menu-link" href="https://preview.keenthemes.com/metronic8/demo1/layout-builder.html" title="Build your layout, preview and export HTML for server side integration" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                  <span className="menu-icon">
          ...
          <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" className="menu-item menu-lg-down-accordion me-lg-1">
            ...
            <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
              <div className="menu-item">
                <a className="py-3 menu-link" href="../../demo1/dist/documentation/base/utilities.html" title="Check out over 200 in-house components, plugins and ready for use solutions" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                  <span className="menu-icon">
                    {/*begin::Svg Icon | path: /icons/duotune/general/gen002.svg*/}
                    <span className="svg-icon svg-icon-2">
                      <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
              ...
              <div className="menu-item">
                <a className="py-3 menu-link" href="../../demo1/dist/documentation/getting-started.html" title="Check out the complete documentation" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                  <span className="menu-icon">
              ...
              <div className="menu-item">
                <a className="py-3 menu-link" href="../../demo1/dist/documentation/getting-started/changelog.html">
                  <span className="menu-icon">
          ...
          <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" className="menu-item menu-lg-down-accordion me-lg-1">
            ...
            <div className="p-5 menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown w-100 w-lg-600px p-lg-5">
              {/*begin:Row*/}
    ...
    <div className="flex-shrink-0 d-flex align-items-stretch">
      {/*begin::Search*/}
        ...
        <div id="kt_header_search" className="header-search d-flex align-items-stretch" data-kt-search-keypress="true" data-kt-search-min-length={2} data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-menu-trigger="auto" data-kt-menu-overflow="false" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-end">
          ...
          <div data-kt-search-element="content" className="menu menu-sub menu-sub-dropdown p-7 w-325px w-md-375px">
            ...
            <div data-kt-search-element="wrapper">
              {/*begin::Form*/}
              <form data-kt-search-element="form" className="mb-3 w-100 position-relative" autoComplete="off">
                {/*begin::Icon*/}
                {/*begin::Svg Icon | path: icons/duotune/general/gen021.svg*/}
                ...
                <span className="position-absolute top-50 end-0 translate-middle-y lh-0 d-none me-1" data-kt-search-element="spinner">
                  <span className="text-gray-400 align-middle spinner-border h-15px w-15px" />
                </span>
                {/*end::Spinner*/}
                {/*begin::Reset*/}
              ...
              {/*end::Form*/}
              {/*begin::Separator*/}
              <div className="mb-6 border-gray-200 separator" />
              {/*end::Separator*/}
              ...
              <div data-kt-search-element="results" className="d-none">
                ...
                <div className="scroll-y mh-200px mh-lg-350px">
                  ...
                  <h3 className="pb-5 m-0 fs-5 text-muted" data-kt-search-element="category-title">Users</h3>
                  {/*end::Category title*/}
                  {/*begin::Item*/}
                  <a href="#" className="mb-5 d-flex text-dark text-hover-primary align-items-center">
                    {/*begin::Symbol*/}
                  ...
                  {/*end::Item*/}
                  {/*begin::Category title*/}
                  <h3 className="pt-5 pb-5 m-0 fs-5 text-muted" data-kt-search-element="category-title">Customers</h3>
                  {/*end::Category title*/}
                  {/*begin::Item*/}
                  <a href="#" className="mb-5 d-flex text-dark text-hover-primary align-items-center">
                    {/*begin::Symbol*/}
                  ...
                  {/*end::Item*/}
                  {/*begin::Category title*/}
                  <h3 className="pt-5 pb-5 m-0 fs-5 text-muted" data-kt-search-element="category-title">Projects</h3>
                  {/*end::Category title*/}
                  {/*begin::Item*/}
                  <a href="#" className="mb-5 d-flex text-dark text-hover-primary align-items-center">
                    {/*begin::Symbol*/}
              ...
              <div className="mb-5" data-kt-search-element="main">
                {/*begin::Heading*/}
                <div className="mb-4 d-flex flex-stack fw-bold">
                  {/*begin::Label*/}
                ...
                <div className="scroll-y mh-200px mh-lg-325px">
                  ...
                  <div className="mb-5 d-flex align-items-center">
                    ...
                    {/*begin::Title*/}
                    <div className="d-flex flex-column">
                      <a href="#" className="text-gray-800 fs-6 text-hover-primary fw-bold">BoomApp by Keenthemes</a>
                  ...
                  <div className="mb-5 d-flex align-items-center">
                    ...
                    {/*begin::Title*/}
                    <div className="d-flex flex-column">
                      <a href="#" className="text-gray-800 fs-6 text-hover-primary fw-bold">"Kept API Project Meeting</a>
                  ...
                  <div className="mb-5 d-flex align-items-center">
                    ...
                    {/*begin::Title*/}
                    <div className="d-flex flex-column">
                      <a href="#" className="text-gray-800 fs-6 text-hover-primary fw-bold">"KPI Monitoring App Launch</a>
                  ...
                  <div className="mb-5 d-flex align-items-center">
                    ...
                    {/*begin::Title*/}
                    <div className="d-flex flex-column">
                      <a href="#" className="text-gray-800 fs-6 text-hover-primary fw-bold">Project Reference FAQ</a>
                  ...
                  <div className="mb-5 d-flex align-items-center">
                    ...
                    {/*begin::Title*/}
                    <div className="d-flex flex-column">
                      <a href="#" className="text-gray-800 fs-6 text-hover-primary fw-bold">"FitPro App Development</a>
                      <span className="fs-7 text-muted fw-bold">#84250</span>
                    </div>
                    {/*end::Title*/}
                  </div>
                  ...
                  <div className="mb-5 d-flex align-items-center">
                    ...
                    {/*begin::Title*/}
                    <div className="d-flex flex-column">
                      <a href="#" className="text-gray-800 fs-6 text-hover-primary fw-bold">Shopix Mobile App</a>
                  ...
                  <div className="mb-5 d-flex align-items-center">
                    ...
                    {/*begin::Title*/}
                    <div className="d-flex flex-column">
                      <a href="#" className="text-gray-800 fs-6 text-hover-primary fw-bold">"Landing UI Design" Launch</a>
              ...
              <div data-kt-search-element="empty" className="text-center d-none">
                ...
                <div className="pt-10 pb-10">
                  ...
                  <span className="opacity-50 svg-icon svg-icon-4x">
                    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                      <path opacity="0.3" d="M14 2H6C4.89543 2 4 2.89543 4 4V20C4 21.1046 4.89543 22 6 22H18C19.1046 22 20 21.1046 20 20V8L14 2Z" fill="currentColor" />
                      <path d="M20 8L14 2V6C14 7.10457 14.8954 8 16 8H20Z" fill="currentColor" />
                ...
                <div className="pb-15 fw-bold">
                  <h3 className="mb-2 text-gray-600 fs-5">No result found</h3>
              ...
              <div className="mb-5">
                ...
                <div className="nav-group nav-group-fluid">
                  ...
                  <label>
                    ...
                    <span className="px-4 btn btn-sm btn-color-muted btn-active btn-active-primary">Users</span>
                  </label>
                  {/*end::Option*/}
                  {/*begin::Option*/}
                  <label>
                    <input type="radio" className="btn-check" name="type" defaultValue="orders" />
                    <span className="px-4 btn btn-sm btn-color-muted btn-active btn-active-primary">Orders</span>
                  </label>
                  {/*end::Option*/}
                  {/*begin::Option*/}
                  <label>
                    <input type="radio" className="btn-check" name="type" defaultValue="projects" />
                    <span className="px-4 btn btn-sm btn-color-muted btn-active btn-active-primary">Projects</span>
                  </label>
                  {/*end::Option*/}
                </div>
                {/*end::Radio group*/}
              ...
              <div className="mb-5">
                ...
                <div className="nav-group nav-group-fluid">
                  ...
                  <label>
                    ...
                    <span className="px-4 btn btn-sm btn-color-muted btn-active btn-active-primary">Any</span>
                  </label>
                  {/*end::Option*/}
                </div>
                {/*end::Radio group*/}
            ...
            <form data-kt-search-element="preferences" className="pt-1 d-none">
              ...
              <div className="pb-4 border-bottom">
                <label className="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                  <span className="text-gray-700 form-check-label fs-6 fw-bold ms-0 me-2">Projects</span>
              ...
              <div className="py-4 border-bottom">
                <label className="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                  <span className="text-gray-700 form-check-label fs-6 fw-bold ms-0 me-2">Targets</span>
                  <input className="form-check-input" type="checkbox" defaultValue={1} defaultChecked="checked" />
                </label>
              </div>
              {/*end::Input group*/}
              ...
              <div className="py-4 border-bottom">
                <label className="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                  <span className="text-gray-700 form-check-label fs-6 fw-bold ms-0 me-2">Affiliate Programs</span>
              ...
              <div className="py-4 border-bottom">
                <label className="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                  <span className="text-gray-700 form-check-label fs-6 fw-bold ms-0 me-2">Referrals</span>
                  <input className="form-check-input" type="checkbox" defaultValue={1} defaultChecked="checked" />
                </label>
              </div>
              {/*end::Input group*/}
              ...
              <div className="py-4 border-bottom">
                <label className="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                  <span className="text-gray-700 form-check-label fs-6 fw-bold ms-0 me-2">Users</span>
                  <input className="form-check-input" type="checkbox" defaultValue={1} />
                </label>
              </div>
              {/*end::Input group*/}
      ...
      <div className="d-flex align-items-center ms-1 ms-lg-3">
        ...
        <div className="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
          ...
          <div className="d-flex flex-column bgi-no-repeat rounded-top" style={{backgroundImage: 'url("assets/media/misc/pattern-1.jpg")'}}>
            {/*begin::Title*/}
            <h3 className="mt-10 mb-6 text-white fw-bold px-9">Notifications
              <span className="opacity-75 fs-8 ps-3">24 reports</span></h3>
            {/*end::Title*/}
            {/*begin::Tabs*/}
            <ul className="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-bold px-9">
              <li className="nav-item">
                <a className="pb-4 text-white opacity-75 nav-link opacity-state-100" data-bs-toggle="tab" href="#kt_topbar_notifications_1">Alerts</a>
              </li>
              <li className="nav-item">
                <a className="pb-4 text-white opacity-75 nav-link opacity-state-100 active" data-bs-toggle="tab" href="#kt_topbar_notifications_2">Updates</a>
              </li>
              <li className="nav-item">
                <a className="pb-4 text-white opacity-75 nav-link opacity-state-100" data-bs-toggle="tab" href="#kt_topbar_notifications_3">Logs</a>
              </li>
            </ul>
            {/*end::Tabs*/}
          </div>
          ...
          <div className="tab-content">
            ...
            <div className="tab-pane fade" id="kt_topbar_notifications_1" role="tabpanel">
              {/*begin::Items*/}
              <div className="px-8 my-5 scroll-y mh-325px">
                {/*begin::Item*/}
                <div className="py-4 d-flex flex-stack">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <div className="mb-0 me-2">
                      <a href="#" className="text-gray-800 fs-6 text-hover-primary fw-bolder">Project Alice</a>
                ...
                <div className="py-4 d-flex flex-stack">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    {/*begin::Title*/}
                    <div className="mb-0 me-2">
                      <a href="#" className="text-gray-800 fs-6 text-hover-primary fw-bolder">HR Confidential</a>
                ...
                <div className="py-4 d-flex flex-stack">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    {/*begin::Title*/}
                    <div className="mb-0 me-2">
                      <a href="#" className="text-gray-800 fs-6 text-hover-primary fw-bolder">Company HR</a>
                ...
                <div className="py-4 d-flex flex-stack">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    {/*begin::Title*/}
                    <div className="mb-0 me-2">
                      <a href="#" className="text-gray-800 fs-6 text-hover-primary fw-bolder">Project Redux</a>
                ...
                <div className="py-4 d-flex flex-stack">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    {/*begin::Title*/}
                    <div className="mb-0 me-2">
                      <a href="#" className="text-gray-800 fs-6 text-hover-primary fw-bolder">Project Breafing</a>
                ...
                <div className="py-4 d-flex flex-stack">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    {/*begin::Title*/}
                    <div className="mb-0 me-2">
                      <a href="#" className="text-gray-800 fs-6 text-hover-primary fw-bolder">Banner Assets</a>
                ...
                <div className="py-4 d-flex flex-stack">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    {/*begin::Title*/}
                    <div className="mb-0 me-2">
                      <a href="#" className="text-gray-800 fs-6 text-hover-primary fw-bolder">Icon Assets</a>
            ...
            <div className="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
              ...
              <div className="d-flex flex-column px-9">
                ...
                <div className="pt-10 pb-0">
                  {/*begin::Title*/}
                  <h3 className="text-center text-dark fw-bolder">Get Pro Access</h3>
                  {/*end::Title*/}
                  {/*begin::Text*/}
                  <div className="pt-1 text-center text-gray-600 fw-bold">Outlines keep you honest. They stoping you from amazing poorly about drive</div>
                  {/*end::Text*/}
                  {/*begin::Action*/}
                  <div className="mt-5 text-center mb-9">
                    <a href="#" className="px-6 btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Upgrade</a>
                  </div>
                  {/*end::Action*/}
                </div>
                {/*end::Section*/}
      ...
      <div className="d-flex align-items-center ms-1 ms-lg-3">
        ...
        <div className="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
          {/*begin::Heading*/}
          <div className="py-10 d-flex flex-column flex-center bgi-no-repeat rounded-top px-9" style={{backgroundImage: 'url("assets/media/misc/pattern-1.jpg")'}}>
            {/*begin::Title*/}
            <h3 className="mb-3 text-white fw-bold">Quick Links</h3>
            {/*end::Title*/}
            {/*begin::Status*/}
            <span className="px-3 py-2 badge bg-primary">25 pending tasks</span>
            {/*end::Status*/}
          </div>
          {/*end::Heading*/}
          {/*begin:Nav*/}
          <div className="row g-0">
            {/*begin:Item*/}
            <div className="col-6">
              <a href="../../demo1/dist/apps/projects/budget.html" className="p-6 d-flex flex-column flex-center h-100 bg-hover-light border-end border-bottom">
                {/*begin::Svg Icon | path: icons/duotune/finance/fin009.svg*/}
                <span className="mb-2 svg-icon svg-icon-3x svg-icon-primary">
                  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                ...
                {/*end::Svg Icon*/}
                <span className="mb-0 text-gray-800 fs-5 fw-bold">Accounting</span>
                <span className="text-gray-400 fs-7">eCommerce</span>
              </a>
            </div>
            {/*end:Item*/}
            {/*begin:Item*/}
            <div className="col-6">
              <a href="../../demo1/dist/apps/projects/settings.html" className="p-6 d-flex flex-column flex-center h-100 bg-hover-light border-bottom">
                {/*begin::Svg Icon | path: icons/duotune/communication/com010.svg*/}
                <span className="mb-2 svg-icon svg-icon-3x svg-icon-primary">
                  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                    <path d="M6 8.725C6 8.125 6.4 7.725 7 7.725H14L18 11.725V12.925L22 9.725L12.6 2.225C12.2 1.925 11.7 1.925 11.4 2.225L2 9.725L6 12.925V8.725Z" fill="currentColor" />
                ...
                {/*end::Svg Icon*/}
                <span className="mb-0 text-gray-800 fs-5 fw-bold">Administration</span>
                <span className="text-gray-400 fs-7">Console</span>
              </a>
            </div>
            {/*end:Item*/}
            {/*begin:Item*/}
            <div className="col-6">
              <a href="../../demo1/dist/apps/projects/list.html" className="p-6 d-flex flex-column flex-center h-100 bg-hover-light border-end">
                {/*begin::Svg Icon | path: icons/duotune/abstract/abs042.svg*/}
                <span className="mb-2 svg-icon svg-icon-3x svg-icon-primary">
                  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                    <path d="M18 21.6C16.6 20.4 9.1 20.3 6.3 21.2C5.7 21.4 5.1 21.2 4.7 20.8L2 18C4.2 15.8 10.8 15.1 15.8 15.8C16.2 18.3 17 20.5 18 21.6ZM18.8 2.8C18.4 2.4 17.8 2.20001 17.2 2.40001C14.4 3.30001 6.9 3.2 5.5 2C6.8 3.3 7.4 5.5 7.7 7.7C9 7.9 10.3 8 11.7 8C15.8 8 19.8 7.2 21.5 5.5L18.8 2.8Z" fill="currentColor" />
                ...
                {/*end::Svg Icon*/}
                <span className="mb-0 text-gray-800 fs-5 fw-bold">Projects</span>
                <span className="text-gray-400 fs-7">Pending Tasks</span>
              </a>
            </div>
            {/*end:Item*/}
            {/*begin:Item*/}
            <div className="col-6">
              <a href="../../demo1/dist/apps/projects/users.html" className="p-6 d-flex flex-column flex-center h-100 bg-hover-light">
                {/*begin::Svg Icon | path: icons/duotune/finance/fin006.svg*/}
                <span className="mb-2 svg-icon svg-icon-3x svg-icon-primary">
                  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                    <path opacity="0.3" d="M20 15H4C2.9 15 2 14.1 2 13V7C2 6.4 2.4 6 3 6H21C21.6 6 22 6.4 22 7V13C22 14.1 21.1 15 20 15ZM13 12H11C10.5 12 10 12.4 10 13V16C10 16.5 10.4 17 11 17H13C13.6 17 14 16.6 14 16V13C14 12.4 13.6 12 13 12Z" fill="currentColor" />
                ...
                {/*end::Svg Icon*/}
                <span className="mb-0 text-gray-800 fs-5 fw-bold">Customers</span>
                <span className="text-gray-400 fs-7">Latest cases</span>
              </a>
            </div>
            {/*end:Item*/}
          </div>
      ...
      <div className="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
        ...
        <div className="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold fs-6 w-275px" data-kt-menu="true">
          {/*begin::Menu item*/}
            ...
            <div className="px-3 menu-content d-flex align-items-center">
              ...
              <div className="d-flex flex-column">
                <div className="fw-bolder d-flex align-items-center fs-5">Max Smith
                  <span className="px-2 py-1 badge badge-light-success fw-bolder fs-8 ms-2">Pro</span></div>
          ...
          <div className="px-5 menu-item">
            <a href="../../demo1/dist/account/overview.html" className="px-5 menu-link">My Profile</a>
          </div>
          {/*end::Menu item*/}
          {/*begin::Menu item*/}
          <div className="px-5 menu-item">
            <a href="../../demo1/dist/apps/projects/list.html" className="px-5 menu-link">
          ...
          {/*end::Menu item*/}
          {/*begin::Menu item*/}
          <div className="px-5 menu-item" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start">
            ...
            <div className="py-4 menu-sub menu-sub-dropdown w-175px">
              {/*begin::Menu item*/}
              <div className="px-3 menu-item">
                <a href="../../demo1/dist/account/referrals.html" className="px-5 menu-link">Referrals</a>
              </div>
              {/*end::Menu item*/}
              {/*begin::Menu item*/}
              <div className="px-3 menu-item">
                <a href="../../demo1/dist/account/billing.html" className="px-5 menu-link">Billing</a>
              </div>
              {/*end::Menu item*/}
              {/*begin::Menu item*/}
              <div className="px-3 menu-item">
                <a href="../../demo1/dist/account/statements.html" className="px-5 menu-link">Payments</a>
              </div>
              {/*end::Menu item*/}
              {/*begin::Menu item*/}
              <div className="px-3 menu-item">
                <a href="../../demo1/dist/account/statements.html" className="px-5 menu-link d-flex flex-stack">Statements
          ...
          {/*begin::Menu item*/}
          <div className="px-5 menu-item">
            <a href="../../demo1/dist/account/statements.html" className="px-5 menu-link">My Statements</a>
          </div>
          {/*end::Menu item*/}
          {/*begin::Menu separator*/}
          <div className="my-2 separator" />
          ...
          <div className="px-5 menu-item" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start">
            <a href="#" className="px-5 menu-link">
              <span className="menu-title position-relative">Language
                <span className="px-3 py-2 rounded fs-8 bg-light position-absolute translate-middle-y top-50 end-0">English
            ...
            <div className="py-4 menu-sub menu-sub-dropdown w-175px">
              {/*begin::Menu item*/}
              <div className="px-3 menu-item">
                <a href="../../demo1/dist/account/settings.html" className="px-5 menu-link d-flex active">
              ...
              {/*begin::Menu item*/}
              <div className="px-3 menu-item">
                <a href="../../demo1/dist/account/settings.html" className="px-5 menu-link d-flex">
                  <span className="symbol symbol-20px me-4">
          ...
          <div className="px-5 my-1 menu-item">
            <a href="../../demo1/dist/account/settings.html" className="px-5 menu-link">Account Settings</a>
          </div>
          {/*end::Menu item*/}
          {/*begin::Menu item*/}
          <div className="px-5 menu-item">
            <a href="../../demo1/dist/authentication/flows/basic/sign-in.html" className="px-5 menu-link">Sign Out</a>
          </div>
          {/*end::Menu item*/}
          {/*begin::Menu separator*/}
          <div className="my-2 separator" />
          ...
          {/*begin::Menu item*/}
          <div className="px-5 menu-item">
            <div className="px-5 menu-content">
              <label className="form-check form-switch form-check-custom form-check-solid pulse pulse-success" htmlFor="kt_user_menu_dark_mode_toggle">
                ...
                <span className="text-gray-600 form-check-label fs-7">Dark Mode</span>
              </label>
            </div>
          </div>
          {/*end::Menu item*/}

...
<div id="kt_aside" className="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
  ...
  <div className="aside-logo flex-column-auto" id="kt_aside_logo">
    ...
    {/*end::Logo*/}
    {/*begin::Aside toggler*/}
    <div id="kt_aside_toggle" className="w-auto px-0 btn btn-icon btn-active-color-primary aside-toggle" data-kt-toggle="true" data-kt-toggle-state="active" data-kt-toggle-target="body" data-kt-toggle-name="aside-minimize">
      {/*begin::Svg Icon | path: icons/duotune/arrows/arr079.svg*/}
      <span className="rotate-180 svg-icon svg-icon-1">
  ...
  <div className="aside-menu flex-column-fluid">
    {/*begin::Aside Menu*/}
    <div className="my-5 hover-scroll-overlay-y my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset={0}>
      {/*begin::Menu*/}
      <div className="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
          ...
          <div className="menu-sub menu-sub-accordion menu-active-bg">
            ...
            <div className="menu-item">
              <div className="menu-content">
                <a className="p-0 mb-2 btn btn-flex btn-color-success fs-base ms-2 collapsible collapsed rotate" data-bs-toggle="collapse" href="#kt_aside_menu_collapse" data-kt-toggle-text="Show Less">
        ...
        <div data-kt-menu-trigger="click" className="mb-1 menu-item menu-accordion">
          <span className="menu-link">
            <span className="menu-icon">
        ...
        <div className="menu-item">
          <div className="pt-8 pb-0 menu-content">
        ...
        <div className="menu-item">
          <div className="menu-content">
            <div className="mx-1 my-4 separator" />
          </div>
        </div>
        <div className="menu-item">
  ...
  {/*end::Aside menu*/}
  {/*begin::Footer*/}
  <div className="px-5 pt-5 aside-footer flex-column-auto pb-7" id="kt_aside_footer">
